...
public class Menu {
  ...
  private void createPizzaMenu() {
    ...
    Pizza pizza16 = new Pizza("Sofus", "tomatsauce, ost, kebab og salat", 60);
    Pizza pizza17 = new Pizza("Viking", "tomatsauce, ost, grøn peberfrugt og oksekød", 57);
    Pizza pizza18 = new Pizza("La Luna", "tomatsauce, ost, kødstrimler og champignon", 65);
    Pizza pizza19 = new Pizza("Mimosa", "tomatsauce, ost, kebab og champignon", 57);
    Pizza pizza20 = new Pizza("Venedig", "tomatsauce, ost, kylling og hvidløg", 65);
    Pizza pizza21 = new Pizza("Pollo", "tomatsauce, ost, bacon og løg", 57);
    Pizza pizza22 = new Pizza("San Remo", "tomatsauce, ost, pepperoni og kebab", 61);
    Pizza pizza23 = new Pizza("Bari", "tomatsauce, ost, grøn peberfrugt og hvidløg", 61);
    ...
    Pizza pizza29 = new Pizza("Silicia", "tomatsauce, ost, ananas og rød peberfrugt", 60);
    Pizza pizza30 = new Pizza("Alanya", "tomatsauce, ost, kebab og rejer", 65);
